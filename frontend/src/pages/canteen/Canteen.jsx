...
const workerTypes = ['permanent', 'contract', 'casual', 'temporary']
const mealTypes = ['breakfast', 'lunch', 'dinner', 'snacks']
const orderStatuses = ['pending', 'confirmed', 'preparing', 'ready', 'served', 'cancelled']
...
export default function Canteen() {
  ...
  const menuItemsMap = useMemo(() => new Map(), [])
  ...
  const orderStatusMutation = useMutation({
    mutationFn: ({ id, status }) => canteenService.updateOrderStatus(id, status),
    onSuccess: () => {
          ...
          <CardContent>
            ...
            <Stack spacing={2}>
              ...
              <FormControl fullWidth>
                ...
                <Select label="Type" value={workerForm.worker_type} onChange={(e) => setWorkerForm((p) => ({ ...p, worker_type: e.target.value }))}>
          ...
          <CardContent>
            ...
            <Stack spacing={2}>
              ...
              <FormControl fullWidth>
                ...
                <Select label="Meal" value={menuForm.meal_type} onChange={(e) => setMenuForm((p) => ({ ...p, meal_type: e.target.value }))}>
        ...
        <Card>
          <CardContent>
            ...
            <Stack spacing={2}>
              ...
              <FormControl fullWidth>
                <InputLabel>Meal</InputLabel>
                <Select label="Meal" value={orderForm.meal_type} onChange={(e) => setOrderForm((p) => ({ ...p, meal_type: e.target.value }))}>
                  {mealTypes.map((m) => <MenuItem key={m} value={m}>{m}</MenuItem>)}
                </Select>
              </FormControl>
              <FormControl fullWidth>
        ...
        <Card>
          <CardContent>
            ...
            <Stack spacing={2}>
              ...
              <FormControl fullWidth>
                <InputLabel>Meal</InputLabel>
                <Select label="Meal" value={feedbackForm.meal_type} onChange={(e) => setFeedbackForm((p) => ({ ...p, meal_type: e.target.value }))}>
                  {mealTypes.map((m) => <MenuItem key={m} value={m}>{m}</MenuItem>)}
                </Select>
              </FormControl>
        ...
        <Card>
          <CardContent>
            ...
            <Stack spacing={2}>
              ...
              <FormControl fullWidth>
                <InputLabel>Meal</InputLabel>
                <Select label="Meal" value={consumptionForm.meal_type} onChange={(e) => setConsumptionForm((p) => ({ ...p, meal_type: e.target.value }))}>
                  {mealTypes.map((m) => <MenuItem key={m} value={m}>{m}</MenuItem>)}
                </Select>
              </FormControl>
