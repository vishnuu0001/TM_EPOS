...
export default function Vigilance() {
  ...
  const incidentAckMutation = useMutation({
    mutationFn: (id) => vigilanceService.acknowledgeIncident(id),
    onSuccess: () => {
  ...
  const incidentResolveMutation = useMutation({
    mutationFn: ({ id, notes }) => vigilanceService.resolveIncident(id, notes),
    onSuccess: () => {
  ...
  const sosAckMutation = useMutation({
    mutationFn: (id) => vigilanceService.acknowledgeSOS(id),
    onSuccess: () => {
  ...
  const sosResolveMutation = useMutation({
    mutationFn: ({ id, notes }) => vigilanceService.resolveSOS(id, notes, false),
    onSuccess: () => {
            ...
            <Stack spacing={2}>
              ...
              <FormControl fullWidth>
                ...
                <Select
                  ...
                  onChange={(e) => setRosterForm((p) => ({ ...p, shift_type: e.target.value }))}
                >
                  {shiftTypes.map((s) => (
